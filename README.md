# Warp Hr Go API Library

<!-- x-release-please-start-version -->

<a href="https://pkg.go.dev/github.com/stainless-sdks/warp-hr-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/warp-hr-go.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/stainless-sdks/warp-hr-go" // imported as warphr
)
```
...
```sh
go get -u 'github.com/stainless-sdks/warp-hr-go@v0.0.1'
```
...
The warphr library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/warp-hr-go/option).
...
`*warphr.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `warphr.File(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/warp-hr-go/issues) with questions, bugs, or suggestions.
