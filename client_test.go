...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.TimeOff.Policies.List(context.Background(), warphr.TimeOffPolicyListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.TimeOff.Policies.List(cancelCtx, warphr.TimeOffPolicyListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.TimeOff.Policies.List(deadlineCtx, warphr.TimeOffPolicyListParams{})
		if err == nil {
